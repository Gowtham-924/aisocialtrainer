      ...
      <div className={`${styles.dashboardContent} ${!isParentRestrictionEnabled ? styles.withNav : ""}`}>
        ...
        <h2 className={styles.tipsTitle}>Tips for Effective Use</h2>
          {isParentRestrictionEnabled ? (
            ...
            <div>
        <h3 className={styles.tipsTitle}>1. How to Use AI Social Trainer</h3>
          <p className={styles.tipsText}>
                AI Social Trainer is designed to help users improve communication skills through various scenarios.
              </p>
